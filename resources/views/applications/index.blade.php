...
<div class="dashboard_content">
    <h2 class="welcome-title">Welcome back: {{Auth::user()->jobseeker->first_name}}</h2>
    <div class="applications">
                        ...
                        <div class="items">
                            <article>
                                ...
                                <div class="button_container">
                                    <a class="show_button">More Details</a>
                                    {{--href="{{ route('posts.show', $jobPost->id, $user->id, $address->id) }}"--}}
                                </div>
                            </article>
                        </div>
                    </div>
        ...
        <div class="right">
            <div class="notifications_section">
                ...
                <li>Lorem ipsum dolor amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</li>
